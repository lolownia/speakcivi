...
return array(
  ...
  'field_activity_content' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
    'name' => 'field_activity_content',
    'type' => 'String',
    'quick_form_type' => 'Element',
    'html_type' => 'text',
    'default' => 'custom_4',
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Custom field for content activity',
    'description' => "Custom field for content activity",
    'help_text' => "Custom field for content activity",
  ),
  'field_contribution_source' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
    'name' => 'field_contribution_source',
    'type' => 'String',
    'quick_form_type' => 'Element',
    'html_type' => 'text',
    'default' => 'custom_5',
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Custom field for source contribution',
    'description' => "Custom field for source contribution",
    'help_text' => "Custom field for source contribution",
  ),
  'field_contribution_medium' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
    'name' => 'field_contribution_medium',
    'type' => 'String',
    'quick_form_type' => 'Element',
    'html_type' => 'text',
    'default' => 'custom_6',
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Custom field for medium contribution',
    'description' => "Custom field for medium contribution",
    'help_text' => "Custom field for medium contribution",
  ),
  'field_contribution_campaign' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
    'name' => 'field_contribution_campaign',
    'type' => 'String',
    'quick_form_type' => 'Element',
    'html_type' => 'text',
    'default' => 'custom_7',
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Custom field for campaign contribution',
    'description' => "Custom field for campaign contribution",
    'help_text' => "Custom field for campaign contribution",
  ),
  'field_contribution_content' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
    'name' => 'field_contribution_content',
    'type' => 'String',
    'quick_form_type' => 'Element',
    'html_type' => 'text',
    'default' => 'custom_8',
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Custom field for content contribution',
    'description' => "Custom field for content contribution",
    'help_text' => "Custom field for content contribution",
  ),
  'from' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
